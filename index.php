...
<body>
	<div id="head">
		...
		<ul class="utility">
			...
			<li> | </li>
			<li>{$langues[$langue]['versa']} ${apacheVersion}</li>
			<li> | </li>
			<li>{$langues[$langue]['versp']} ${phpVersion}</li>
			<li> | </li>
			<li>{$langues[$langue]['versm']} ${mysqlVersion}</li>
			<li><a href="?lang={$langues[$langue]['autreLangueLien']}" class="language-link">{$langues[$langue]['autreLangue']}</a></li>
		</ul>
	</div>	
	<div class="main project-main">
			<ul class="projects">
	...
	<div class="main ext-main">
		<h2>{$langues[$langue]['phpExt']}</h2> 
		<span class="show-button"><p>Afficher</p> <em class="loaded-n"></em></span>
		<dd class="ext-loaded closed">
			<ul>
			${phpExtContents}
			</ul>
		</dd>
	...
	<div id="foot">
		...
		<p>Made with &hearts; by <a href="http://stephan-thomas.fr">Thomas Stephan</a></p>
	</div>
